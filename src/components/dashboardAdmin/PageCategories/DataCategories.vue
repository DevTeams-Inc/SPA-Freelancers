  ...
  <div class="container-dataCategories">
    ...
    <div class="table-categories">
      ...
      >
        ...
        <el-table-column label="Icono" prop="img">
      ...
      <el-dialog title="Editar Categoria" :visible.sync="dialogFormEditarVisible">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm">
          <el-form-item prop="name">
            <el-input v-model="ruleForm.name" placeholder="Nombre de la categoria" size="medium"></el-input>
          </el-form-item>
          ...
          <el-form-item prop="img">
            <el-input v-model="ruleForm.img" placeholder="icono de la categoria" size="medium"></el-input>
          </el-form-item>
        </el-form>
        <span slot="footer" class="dialog-footer">
          <div class="botones-dialog">
            ...
            <el-button
              id="botonesDialog"
              @click=" edit('ruleForm') , dialogoFormEditarVisible=false"
              type="primary"
      ...
      <el-dialog
        title="Realmente deseas eliminar esta categoria?"
